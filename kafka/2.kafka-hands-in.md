...
...
  - addresses:
    - host: my-cluster.kafka.localhost.127.0.0.1.nip.io
      port: 32100
    bootstrapServers: my-cluster.kafka.localhost.127.0.0.1.nip.io:32100
    name: external
    type: external
---
...
$ kubectl -n kafka get svc
NAME                                  TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)                               AGE
my-cluster-zookeeper-client           ClusterIP   10.43.21.153    <none>        2181/TCP                              52m
my-cluster-zookeeper-nodes            ClusterIP   None            <none>        2181/TCP,2888/TCP,3888/TCP            52m
my-cluster-kafka-brokers              ClusterIP   None            <none>        9090/TCP,9091/TCP,9092/TCP,9093/TCP   52m
my-cluster-kafka-external-bootstrap   NodePort    10.43.107.247   <none>        9094:32100/TCP                        2m52s
my-cluster-kafka-2                    NodePort    10.43.77.231    <none>        9094:32202/TCP                        2m52s
my-cluster-kafka-bootstrap            ClusterIP   10.43.189.63    <none>        9091/TCP,9092/TCP,9093/TCP            52m
my-cluster-kafka-1                    NodePort    10.43.30.140    <none>        9094:32201/TCP                        2m52s
my-cluster-kafka-0                    NodePort    10.43.246.241   <none>        9094:32200/TCP                        2m52s
...
```sh
bootstrap  : my-cluster.kafka.127.0.0.1.nip.io:32100
broker0    : my-cluster.kafka.127.0.0.1.nip.io:32200
broker1    : my-cluster.kafka.127.0.0.1.nip.io:32201
broker2    : my-cluster.kafka.127.0.0.1.nip.io:32202


# port 가 살아 있는지 netcat 으로 확인해 보자.
$ nc -zv my-cluster.kafka.127.0.0.1.nip.io 32100
Connection to my-cluster.kafka.localhost.127.0.0.1.nip.io (127.0.0.1) 32100 port [tcp/*] succeeded!

$ nc -zv my-cluster.kafka.127.0.0.1.nip.io 32200
Connection to my-cluster.kafka.localhost.127.0.0.1.nip.io (127.0.0.1) 32200 port [tcp/*] succeeded!

$ nc -zv my-cluster.kafka.127.0.0.1.nip.io 32201
Connection to my-cluster.kafka.localhost.127.0.0.1.nip.io (127.0.0.1) 32201 port [tcp/*] succeeded!

$ nc -zv my-cluster.kafka.127.0.0.1.nip.io 32202
Connection to my-cluster.kafka.localhost.127.0.0.1.nip.io (127.0.0.1) 32202 port [tcp/*] succeeded!

# 모두 succeeded 인 것을 확인할 수 있다.


# 존재하지 않는 port 는 아래와 같이 refused 된다.
$ nc -zv my-cluster.kafka.127.0.0.1.nip.io 32203
...
bootstrap  : my-cluster.kafka.localhost.127.0.0.1.nip.io:32100
broker0    : my-cluster.kafka.localhost.127.0.0.1.nip.io:32200
broker1    : my-cluster.kafka.localhost.127.0.0.1.nip.io:32201
broker2    : my-cluster.kafka.localhost.127.0.0.1.nip.io:32202
...
$
nc -zv my-cluster.kafka.localhost.127.0.0.1.nip.io 32100
```
...
# python pod 내 진입(bash 실행)
$ kubectl -n kafka exec -it deploy/python -- bash
root@python-7d59455985-ml8vw:/#      <-- 이렇게 변경된되는 모습 확인할것
...
참조링크 : https://docs.spring.io/spring-kafka/reference/html/
