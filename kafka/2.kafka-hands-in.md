...
35.xx.xx.xx --> 34.27.41.215 (자신의 Bastion Server IP)   모두 변경
```
...
```sh
# nip 
my-cluster.kafka.localhost.35.xx.xx.xx.nip.io
```
...
# 127.0.0.1  --> 본인ServerIP(35.xx.xx.xx) 로 변경

# 변경
$ sed -i 's/127.0.0.1/35.xx.xx.xx/' ./kafka/strimzi/kafka/13.kafka-ephemeral-auth-nodeport.yaml
...
...
          - broker: 0
            advertisedHost: my-cluster.kafka.35.xx.xx.xx.nip.io    # 각자의 Node IP로 변경
            nodePort: 32200
          - broker: 1
            advertisedHost: my-cluster.kafka.35.xx.xx.xx.nip.io    # 각자의 Node IP로 변경
            nodePort: 32201
...
...
  - addresses:
    - host: my-cluster.kafka.35.xx.xx.xx.nip.io
      port: 32100
    bootstrapServers: my-cluster.kafka.35.xx.xx.xx.nip.io:32100
    name: external
    type: external
...
```sh
bootstrap  : my-cluster.kafka.35.xx.xx.xx.nip.io:32100
broker0    : my-cluster.kafka.35.xx.xx.xx.nip.io:32200
broker1    : my-cluster.kafka.35.xx.xx.xx.nip.io:32201
broker2    : my-cluster.kafka.35.xx.xx.xx.nip.io:32202


# port 가 살아 있는지 netcat 으로 확인해 보자.
$ nc -zv my-cluster.kafka.35.xx.xx.xx.nip.io 32100
Connection to my-cluster.kafka.35.xx.xx.xx.nip.io (35.xx.xx.xx) 32100 port [tcp/*] succeeded!
...
$ nc -zv my-cluster.kafka.35.xx.xx.xx.nip.io 32203
...
export BROKERS=my-cluster.kafka.35.xx.xx.xx.nip.io:32100
export KAFKAUSER=my-edu-admin
export PASSWORD=UIqVGInn7iZPo36zxJkZbRD3C4tyHXSa        ## 개인별 passwrod 붙여넣자.   위 3.2 KafkaUser 를 참고하자. 
export TOPIC=my-topic
...
Metadata for all topics (from broker -1: sasl_plaintext://my-cluster.kafka.35.xx.xx.xx.nip.io:32100/bootstrap):
 3 brokers:
  broker 0 at my-cluster.kafka.35.xx.xx.xx.nip.io:32200
  broker 2 at my-cluster.kafka.35.xx.xx.xx.nip.io:32202
  broker 1 at my-cluster.kafka.35.xx.xx.xx.nip.io:32201 (controller)
 1 topics:
  topic "my-topic" with 3 partitions:
    partition 0, leader 1, replicas: 1,2,0, isrs: 1,2,0
...
# 개인환경으로 변경
bootstrap_servers='my-cluster.kafka.35.xx.xx.xx.nip.io:32100'
sasl_plain_password='UIqVGInn7iZPo36zxJkZbRD3C4tyHXSa'             ## 개인별 passwrod 붙여넣자.   위 3.2 KafkaUser 를 참고하자. 
sasl_plain_username='my-edu-admin'
group_id='my-topic-group'
